import famu.edu.ChatGptResponse;
import famu.edu.ChatptRequest;
...
public class WtfGpt {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        String input = objectMapper.writeValueAsString(ChatptRequest);

        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("https://api.openai.com/v1/completions"))
                .setHeader("Content-Type", "application/json")
                .setHeader("Authorization", "Bearer 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")
